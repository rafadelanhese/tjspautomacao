...
namespace TjspAutomacao.Model
{
    ...
    {        
        ...
        {
            return "/html/body/span/main/div/div/div/form/div/div/div[1]/div/div/div/article/section[1]/footer/div/ul/li[" + posicao.ToString() +"]/div/nav/div/ul/li[3]/span/div/div[1]/span/span[1]";
        }
